# AGENTS.md - Contexto del Proyecto inv-tienda
...
## Notas Adicionales
- Las skills personalizadas deben colocarse en `.Codex/skills/nombre-de-la-skill/SKILL.md`
- Los archivos existentes en `.agents/skills/` son skills del sistema y no deben ser modificados para skills personalizadas
- Este archivo AGENTS.md sirve como contexto general para futuras iteraciones del proyecto
