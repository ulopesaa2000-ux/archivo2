...
export type UsoImagen = 'principal_ecommerce' | 'galeria_secundaria' | 'ficha_tecnica' | 'marketing_banner' | 'etiqueta_logistica' | 'color_variacion' | 'tallas_variacion' | 'oculta' | 'oculto'
